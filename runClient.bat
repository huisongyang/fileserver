...
rem 启动更新
java -Droot.dir.path=%root.dir.path% -Droot.dir.exclude=%root.dir.exclude% -Droot.dir.excludeDir=%root.dir.excludeDir% -cp autoupdate-2.0.0-SNAPSHOT.jar com.yhs.autoupdate.client.Client 127.0.0.1 9999
